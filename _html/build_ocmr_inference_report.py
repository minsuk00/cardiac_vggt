...
A("<div class='caveat'><b>Does OCMR really breathe, at a smaller scale? — CONCLUSIVE (<span class='mono'>"
  "tools/prove_ocmr_breathing.py</span>).</b> OCMR <i>is</i> free-breathing → it carries <b>real</b> "
  "respiratory motion (not breathing-free), and it is <b>smaller than the sim</b>. Proven three ways: "
  "<b>(1) periodicity</b> — the heart's in-plane displacement (validated subpixel registration, 0.0&nbsp;px "
  "on known shifts) peaks at a <b>physiological respiratory rate</b> (us_0084 <b>10&nbsp;br/min</b>, us_0183 "
  "<b>20&nbsp;br/min</b>), which drift/noise cannot fake; <b>(2) negative control</b> — respiratory-band "
  "power, heart ÷ static background, is <b>×72 (us_0084)</b> and <b>×458 (us_0183)</b> → real anatomical "
  "motion; <b>(3) amplitude via the actual slice tilt</b> (slices 55–83° off SI, so SI is 82–99% in-plane "
  "— no through-plane guesswork): <b>SI = 6.4&nbsp;mm (volunteer), 0.3–1.6&nbsp;mm (patients)</b>, all "
  "<b>below the 16±8&nbsp;mm sim</b> (volunteer ~0.4×, patients ≤0.1×). Real breathing is also a "
  "<b>coherent bulk slide</b> vs the sim's <b>per-slice-incoherent</b> shifts (more destructive to a stack "
  "at equal amplitude). Figure + details: <span class='mono'>docs/08 §3.4</span>.</div>")
