...
# ============================================================================================
# TWOPHASE-DIFF SWEEP ARM w=2.0, 2026-08-24 — runs from the vggt-twophase WORKTREE (branch
...
# --- THE ARM VARIABLE ---
ARM_OVERRIDES="loss.volume.diffusion_weight=0.0 loss.volume.diff_weight=2.0"
VARIANT_TAG="twophase20"
