...
# =============================================================================
# REFINER run B (JOINT) — 3D UNet refiner on the splat, trained JOINTLY with an
...
# target_t ON. Two-term deep-supervised loss L_pre(V_canon)+λ·L_post(V_refined), λ=1.
#
