...
# =============================================================================
# REFINER run A (FROZEN + SSIM) — 3D UNet refiner on the splat, trained with ALL of VGGT
...
# gain (geometry fixed). Breathing ON. Two-term loss L_pre(V_canon)+L_post(V_refined),
# with L_post = λ·L1 + 0.1·(1−SSIM_2d) — the SSIM term adds in-plane sharpness pressure
# mean-seeking L1 can't (vs the L1-only train_refiner_frozen.sh).
#
...
CONFIG="mri_volume"
NGPU=1
EXP_TAG="mri_refiner_frozen_ssim"
