...
# --- Configuration ---
# ============================================================================================
# POOLED-1337 — AGGRESSIVE-AUG, img_size=336 ARM, 2026-08-13. Byte-identical to
# train_pooled1337_dpt_augaggressive.sh except `img_size=336` (vs 518) and checkpointing off:
# the model perceives
# 336² DINOv2 inputs while the splat/render stays at native 256² (docs/73 native-first port,
...
#   max_epochs 200 -> 300
#   gradient checkpointing true -> false (336 fits on A40; docs/76)
...
VARIANT_TAG="augaggr336${VARIANT_SUFFIX:-}"
