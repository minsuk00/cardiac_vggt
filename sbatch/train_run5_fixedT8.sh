...
CONFIG="mri_volume"
NGPU=1
EXP_TAG="mri_volume_fixedT8"                 # → exp_name = <rev_ts>_${EXP_TAG}
RUN_OVERRIDES="max_epochs=200 t_target_fixed=8 logging.wandb_writer.tags=[mri_volume,t8,headonly]"   # fixed t=8 target phase, head-only
MASTER_PORT=29535
# -------------------------------------------------------------------------------
