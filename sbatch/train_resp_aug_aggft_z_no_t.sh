...
# =============================================================================
# RESPIRATORY run 3/3 — breathing ON + AFFINE augmentation, z embedding, NO input-t
# embedding. Head + aggregator finetune (only DINOv2 patch_embed frozen), all 12
...
#   3 (this) breathing + affine aug, use_z=T use_t=F
