...
# --- Configuration ---
# ============================================================================================
# POOLED-1337 — AGGRESSIVE-AUG, img_size=224 ARM, 2026-08-13. Byte-identical to
# train_pooled1337_dpt_augaggressive.sh except `img_size=224` (vs 518) and checkpointing off:
# the model perceives
# 224² DINOv2 inputs while the splat/render stays at native 256² (docs/73 native-first port,
# commit a031ba7). A/B vs the 518 aggressive run (job 57256923) isolates input resolution.
# ============================================================================================
...
PEAK_LR="5e-5"
RECIPE_OVERRIDES="max_epochs=500 \
...
# --- Continuation of the NO-REG paper model (212682843_noreg224, ep 300) to 500 epochs: warm-restart of the cosine
# at where=0.6 (LR ~1.9e-5 -> 1e-8). CKPT_ONLY = FULL resume (weights+optimizer+prev_epoch=299,
# docs/37) into a FRESH exp dir so the original run is untouched. diffusion_weight pinned to 0
# explicitly (the value that run trained with; default.yaml flipped 1000->0 in 652312b).
...
VARIANT_TAG="noreg224cont500${VARIANT_SUFFIX:-}"
...
CKPT_ONLY="/home/minsukc/vggt/scratch/logs/212682843_noreg224_pooled1337/ckpts/checkpoint_last.pt"
