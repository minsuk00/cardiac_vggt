...
CONFIG="mri_volume"
NGPU=1
EXP_TAG="mri_volume_mixed"                   # → exp_name = <rev_ts>_${EXP_TAG}
RUN_OVERRIDES="max_epochs=400 logging.wandb_writer.tags=[mri_volume,multiphase,headonly]"   # run 2: mixed (multi-phase) target, t_target_fixed=null (config default)
MASTER_PORT=29532
# -------------------------------------------------------------------------------
