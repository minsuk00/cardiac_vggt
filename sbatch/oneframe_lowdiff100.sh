...
RESUME_FROM="/home/minsukc/vggt/scratch/logs/215949615_mri_volume_diffusion_oneframe_lowdiff100_dynamic_axial_pooled1343"
...
if [ "${SLURM_RESTART_COUNT:-0}" -gt 0 ]; then
    ...
    if [ ! -z "$RESUME_FROM" ]; then
        ...
        EXP_NAME="${REV_TS}_mri_volume_diffusion_oneframe_lowdiff100_dynamic_axial_pooled1337"
        EXTRA_OVERRIDES="${ABLATION_OVERRIDES}"
        OVERRIDES="exp_name=${EXP_NAME} checkpoint.resume_checkpoint_path=${CKPT_ONLY} ${EXTRA_OVERRIDES}"
