...
CONFIG="mri_volume"
NGPU=1
EXP_TAG="mri_volume_fixedED_aug"             # → exp_name = <rev_ts>_${EXP_TAG}
RUN_OVERRIDES="max_epochs=400 t_target_fixed=0 data.augmentation.enable=true data.augmentation.tier=aggressive logging.wandb_writer.tags=[mri_volume,t0,headonly,aug_aggressive]"   # run 3: fixed ED + GPU augmentation (aggressive, in-plane only)
MASTER_PORT=29533
# -------------------------------------------------------------------------------
