...
| `pooled_uncurated_ablation.txt` | ablation arm | v2 with the 439 curated-out subjects added back to `[train]` (1067/90/180); `[val]`/`[test]` byte-identical to v2. THE uncurated arm for the curated-vs-uncurated ablation (plain `pooled.txt` would leak 6 v2-val + 52 v2-test subjects into train). |
